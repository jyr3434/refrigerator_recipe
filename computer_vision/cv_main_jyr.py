...
import pickle
from Project03.refrigerator_recipe.computer_vision.cv_model import ResNet,Own,img64NN,img224NN
from Project03.refrigerator_recipe.computer_vision.cv_dataset import DataSet
from Project03.refrigerator_recipe.computer_vision.cv_keras_model import keras_resnet50,keras_vgg16,keras_resnet152
...
if __name__ == '__main__':
    ...
    with tf.device('/GPU:0'):
        ...
        modelname_detail = '_jyr_test_144'
        dataset_version = '_jyr_test_144'
        ...
        history = model.fit(train_dataset, epochs=epochs,callbacks=[model_checkpoint_callback],
